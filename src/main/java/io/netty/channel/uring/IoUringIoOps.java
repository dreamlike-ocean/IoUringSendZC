...
public final class IoUringIoOps implements IoOps {
    ...
    static IoUringIoOps newSendZc(
        ...
        return new IoUringIoOps(Native.IORING_OP_SEND_ZC, (byte) 0, IoUringSocketChannel.enable_report ? Native.IORING_SEND_ZC_REPORT_USAGE : 0, fd,
    ...
    static IoUringIoOps newSendmsgZc(int fd, byte flags, int msgFlags, long address, short data) {
        return new IoUringIoOps(Native.IORING_OP_SENDMSG_ZC, flags, IoUringSocketChannel.enable_report ? Native.IORING_SEND_ZC_REPORT_USAGE : 0, fd, 0L, address, 1, msgFlags, data,
                (short) 0, (short) 0, 0, 0);
    }
